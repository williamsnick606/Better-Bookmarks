...
sys.stdout = open("Title_200_Results.txt","a")
print('Title_200_Model:', 'Training set accuracy:', train_acc)
print('Title_200_Model:', 'Test set accuracy:', test_acc)
...
plt.xlabel('Epoch')
plt.ylabel('Accuracy')
plt.savefig('Title_200_Model_'+str(i+1)+'_Acc.png', bbox_inches='tight')
plt.clf()
...
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.savefig('Title_200_Model_'+str(i+1)+'_Loss.png', bbox_inches='tight')
plt.clf()

model.save('title_200_model.h5')
